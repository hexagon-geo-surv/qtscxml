...
/*!
    ...
    transitions, e.g., \l[CPP]{QSignalTransition}s as in this example. See
...
/*!
  ...
  signal. The \l[CPP]{QSignalTransition} class provides a transition
  associated with a signal event. QStateMachine::SignalEvent is part of
